...
export default function configuracionEmpresa(props) {
    ...
    return (<>
        <div className="row-span-2 rounded-2xl shadow-md dark:shadow-md border dark:border-prueba">
            <div className=" flex flex-warp rounded-t-2xl">
                ...
                <div className="w-full  font-sans font-bold flex-1 dark:text-white text-gray-900 uppercase" >Datos de la empresa</div>
