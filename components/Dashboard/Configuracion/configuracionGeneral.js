...
export default function configuracionGeneral(props) {
    ...
    return (<div className="row-span-2 rounded-2xl shadow-md dark:shadow-lg lg:h-60 border">
        <div className="flex flex-warp rounded-t-2xl">
            ...
            <div className="w-full font-semibold flex-1 text-gray-900 dark:text-white uppercase" >Datos Generales</div>
