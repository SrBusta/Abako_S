...
export default function PaginationTable({
    ...
    return (<div className="pagination grid xl:grid-cols-3 grid-cols-1 pt-2 w-full">

        <div className="xl:justify-self-start  justify-self-center p-4 hidden xl:block">
            {/* <span>
                Ir a la pagina  :
                <input
