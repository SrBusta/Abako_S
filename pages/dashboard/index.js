    ...
    return (
        ...
        <Sidebar active='Inicio' color='red' username={data.username}>
            ...
            <div className='flex-1 md:py-5 md:px-10 p-10 mb-10'>
                ...
                !------------------------- Tier 1 ---------------------------!
                    */}
                    <div className='rounded-xl lg:col-span-3 shadow-md h-full border'>



                        <div className="p-2 inline-flex w-full">
                            <div className="w-14 h-14 bg-white relative -my-8 mx-5 rounded-xl shadow-lg grid grid-cols-1">
                ...
                !------------------------- Tier 2 ---------------------------!
                    */}
                    <div className='rounded-xl shadow-md h-full border max-h-56 p-2'>
                ...
                !------------------------- Tier 3 ---------------------------!
                    */}
                    <div className='rounded-xl lg:col-span-4 col-span-1 shadow-md border'>
